    ...
    <>
      <button
        ...
        className={cn(
          ...
          'px-8 py-3.5 text-2xl md:px-14 md:py-4 md:text-3xl',
      ...
      >
        {t.homeEnterCta}
        <ArrowRight className="h-7 w-7 md:h-8 md:w-8" aria-hidden="true" />
      </button>

      <p className="flex items-center gap-2 rounded-full bg-[#fdf5e0]/90 px-4 py-1 ring-1 ring-amber-300/70 shadow-md md:py-1.5">
        <Star className="h-3.5 w-3.5 fill-amber-400 text-amber-500" aria-hidden="true" />
        <span className="font-display text-sm font-semibold text-[#8a5a18] md:text-base">{t.homeJourney}</span>
        <Star className="h-3.5 w-3.5 fill-amber-400 text-amber-500" aria-hidden="true" />
      </p>
    </>
  );
