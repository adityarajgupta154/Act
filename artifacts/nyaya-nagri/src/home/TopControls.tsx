/**
 * Nyaya Nagri — Home top-right pill controls: About / Settings.
 * Settings opens the EXISTING SettingsPanel (accessibility controls live
 * inside Settings — no duplicate systems, redesign brief §7). The dedicated
 * accessibility pill was removed Aug 2026 on user request; the functionality
 * itself is untouched and still reachable via Settings.
 */
