 ...
 *
 * Zones 1 (personal safety / POCSO), 4 (justice system / JJ Act), and
 * 5 (digital safety) are safety-themed. Zones 2 (child labour) and
 ...
 */
export const SAFETY_REMINDER_ZONES = ['zone1', 'zone4', 'zone5'] as const;
