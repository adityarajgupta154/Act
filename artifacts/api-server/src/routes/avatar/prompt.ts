...
const ZONE_TOPICS: Record<string, { name: string; scope: string }> = {
  ...
  zone2: {
    ...
    scope:
      'Child labour awareness: children under 14 must not be employed, adolescents 14-18 are protected from hazardous work, and every child has the right to learn, play, and rest.',
  },
  zone3: {
    name: 'School Rights',
    scope:
