# Consuming Nyaya Nagri Design System in Expo apps

Read `artifacts/nyaya-nagri-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/nyaya-nagri-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/nyaya-nagri-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/nyaya-nagri-ds/lib/native-theme";
import { useColors } from "@workspace/nyaya-nagri-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/nyaya-nagri-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/nyaya-nagri-ds/components/native/badge";
import { Button } from "@workspace/nyaya-nagri-ds/components/native/button";
import { Card } from "@workspace/nyaya-nagri-ds/components/native/card";
```
...
Import and render
`@workspace/nyaya-nagri-ds/components/native/button`, then run Expo
