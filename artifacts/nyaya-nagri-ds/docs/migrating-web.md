# Migrating web UI to Nyaya Nagri Design System

Read `artifacts/nyaya-nagri-ds/docs/AGENTS.md` and
`artifacts/nyaya-nagri-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/nyaya-nagri-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/nyaya-nagri-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/nyaya-nagri-ds/hooks/use-toast`
