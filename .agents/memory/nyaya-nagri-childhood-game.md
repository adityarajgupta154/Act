...
- 27 `ch*` keys in UIStrings + EN + HI (Devanagari, Western numerals, no emojis). Laws hard-coded (§9.8). Distractor scenes implication-only (§9.5): tired/alone child, muted dusk palette — matches the old wrong-scene mood. Helpline digits banned in game copy (smoke regex 1098|155260|112|100).
